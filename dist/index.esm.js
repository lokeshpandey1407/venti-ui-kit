import ae, { useEffect as h } from "react";
var T = { exports: {} }, b = {};
/**
 * @license React
...
function se() {
  ...
  function n(o, s, i) {
    var p = null;
    if (i !== void 0 && (p = "" + i), s.key !== void 0 && (p = "" + s.key), "key" in s) {
      i = {};
      for (var y in s)
        y !== "key" && (i[y] = s[y]);
    } else i = s;
  ...
  return b.Fragment = a, b.jsx = n, b.jsxs = n, b;
}
var g = {};
/**
 * @license React
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (u = null, c !== void 0 && (n(c), u = "" + c), p(t) && (n(t.key), u = "" + t.key), "key" in t) {
        c = {};
        for (var O in t)
          O !== "key" && (c[O] = t[O]);
      } else c = t;
    ...
    g.Fragment = k, g.jsx = function(e, t, c, l, f) {
...
var M;
function le() {
  return M || (M = 1, process.env.NODE_ENV === "production" ? T.exports = se() : T.exports = ce()), T.exports;
}
var v = le();
const E = async () => {
  try {
...
const ve = ({ children: r, type: a, style: n, className: o = "", ...s }) => (h(() => {
  E();
}, []), /* @__PURE__ */ v.jsx(
  "button",
  {
    className: _(ie.button, o),
    type: a,
    style: { ...n },
    ...s,
    children: r
  ...
  heading: de
}, Ee = ({ children: r, style: a, className: n, ...o }) => (h(() => {
  E();
}, []), /* @__PURE__ */ v.jsx(
  "h1",
  {
...
)), me = {}, _e = ({ children: r, style: a, className: n, ...o }) => (h(() => {
  E();
}, []), /* @__PURE__ */ v.jsx(
  "h1",
  {
    className: _(me.surface, n),
    style: { ...a },
    ...o,
    children: r
  }
  ...
  caption: pe
}, Re = ({ children: r, style: a, className: n, ...o }) => (h(() => {
  E();
}, []), /* @__PURE__ */ v.jsx(
  "h1",
  {
    className: _(ye.caption, n),
    style: { ...a },
    ...o,
    children: r
  }
  ...
  surface: be
}, Te = ({ children: r, style: a, className: n, ...o }) => (h(() => {
  E();
}, []), /* @__PURE__ */ v.jsx(
  "div",
  {
    className: _(ge.surface, n),
    style: { ...a },
    ...o,
    children: r
  }
